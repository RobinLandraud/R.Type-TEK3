...
/**
 * \class IAudioEngine
 * \brief Interface for the audio engine
 * Used to play sounds
 */
class IAudioEngine
{
  public:
    virtual ~IAudioEngine() = default; /*!< Default destructor */

    /**
     * \fn virtual int createSound(std::string& name, std::string& source) = 0;
     * \brief Create a sound
     * \param name Name of the sound
     * \param source Path to the sound file
     * \return Error code
     */
    virtual int createSound(std::string& name, std::string& source) = 0;

    /**
     * \fn virtual void playSound(std::string& name) = 0;
     * \brief Play a sound
     * \param name Name of the sound
     */
    ...
    /**
     * \fn virtual void stopSound(std::string& name) = 0;
     * \brief Stop a sound
     * \param name Name of the sound
     */
    ...
    /**
     * \fn virtual void pauseSound(std::string& name) = 0;
     * \brief Pause a sound
     * \param name Name of the sound
     */
    ...
    /**
     * \fn virtual void resumeSound(std::string& name) = 0;
     ...
     * \param source Path to the music file
     * \return Error code
     */
